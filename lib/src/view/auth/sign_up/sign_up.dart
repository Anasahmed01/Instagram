...
import 'package:instagram/src/view/auth/sign_up/signup_viewmodel.dart';
                      ...
                      children: [
                        ...
                        CustomTextFields.squareTextField(
                          ...
                          suffixIcon: GestureDetector(
                              onTap: () {
                                viewModel.rebuildUi();
                                if (viewModel.conFPvisible) {
                                  viewModel.conFPvisible = false;
                                } else {
                                  viewModel.conFPvisible = true;
                                }
                              },
                              child: viewModel.conFPvisible == true
                                  ? Icon(
                                  ...
                                  : Icon(Icons.visibility,
                                      color: AppColors.greyColor)),
                          hintColor: AppColors.white.withOpacity(0.8),
                          obscureText: viewModel.conFPvisible,
                        ),
                        const SizedBox(
                          height: 20,
                        ),
